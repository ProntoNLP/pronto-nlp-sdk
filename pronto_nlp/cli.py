...
def main():
    ...
    generate_signal_csv_parser.add_argument('-d', '--db', help='Name of the parse cache databse (e.g. "SEC_10K.db3")', required=True)
    ...
    generate_signal_csv_parser.add_argument('-t', '--tickerlist', help='Ticker list name (e.g. "SnP-500")', required=False)
    ...
    generate_find_matches_csv_parser.add_argument('-d', '--db', help='Name of the parse cache databse (e.g. "SEC_10K.db3")', required=True)
    ...
    generate_find_matches_csv_parser.add_argument('-t', '--tickerlist', help='Ticker list name (e.g. "SnP-500")', required=False)
